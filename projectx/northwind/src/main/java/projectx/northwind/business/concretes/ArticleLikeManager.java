...
import projectx.northwind.core.mapping.ArticleLikeMapper;
...
public class ArticleLikeManager implements ArticleLikeService {
    ...
    public DataResult<List<ArticleLikeResponseDto>> getAll() throws NoArticlesExistException {
        ...
        List<ArticleLikeResponseDto> responseDtoList = new ArrayList<>();

        for (Article article : articles) {

            responseDtoList.add(ArticleLikeMapper.mapArticleLikeResponseDto(article));
        }

        return new SuccessDataResult<List<ArticleLikeResponseDto>>(responseDtoList);
    }
